  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/6 w-16 h-16 md:w-32 md:h-32 border border-gray-300 opacity-20 rotate-45 transform-gpu"></div>
        <div className="absolute bottom-1/4 right-1/6 w-12 h-12 md:w-24 md:h-24 border border-gray-400 opacity-10 rotate-12 transform-gpu"></div>
      </div>
